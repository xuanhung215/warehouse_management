...
const CreateExport = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // TODO: gọi API POST /api/exports
    console.log('Create export', { form, details });
  ...
  return (
    <div style={{ padding: '20px', color: 'white', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        <h2 style={{ margin: 0 }}>Tạo phiếu xuất kho</h2>
        <button
          onClick={() => navigate(-1)}
          style={{
            background: '#1f2937',
      ...
      {/* Thông tin chung */}
      <div style={cardStyle}>
        <h3 style={{ margin: '0 0 16px 0', fontSize: '16px' }}>Thông tin phiếu xuất</h3>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: '16px' }}>
          ...
          <div>
            ...
            <input
              ...
              value={form.reason}
              onChange={handleChange}
              placeholder="Bán hàng, chuyển kho, hủy hàng lỗi..."
              style={inputStyle}
            />
          </div>
        </div>
      ...
      <div style={cardStyle}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
          <h3 style={{ margin: 0, fontSize: '16px' }}>Chi tiết sản phẩm xuất</h3>
          <button
            type="button"
            onClick={addRow}
            style={{
